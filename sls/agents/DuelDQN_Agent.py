...
from sls.learn import ExperienceReplay, DuelingDeepQNetwork
import tensorflow as tf


class DuelDQN_Agent(AbstractAgent):

    def __init__(self, train, screen_size):
        tf.compat.v1.disable_eager_execution()
        super(DuelDQN_Agent, self).__init__(screen_size)
        self.train = train
        ...
        self.dqn_network = DuelingDeepQNetwork(self._DIRECTIONS, train)
